...
class KakaoController {
	private final static String K_CLIENT_ID = "93211593f877e4779406656baf63b985";

	private final static String K_REDIRECT_URI = "http://localhost:9091/www/kakao/callback";
	...
	public static JsonNode getAccessToken(String autorize_code) {
		...
		System.out.println("List in token : " + postParams);
	...
	public static JsonNode getKakaoUserInfo(JsonNode accessToken) {
		System.out.println("Start GetKakaoUserInfo");
